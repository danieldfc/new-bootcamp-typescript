...
- O usuário deve receber com instruções de recuperação de senha;
- O usuário deve poder resetar sua senha;

**RNF**

- Utilizar Mailtrap para testar envios em ambiente de dev;
- Utilizar o Amazon SES para envios de emails em produção;
...
- O usuário deve poder listar seus agendamendos de um dia específico;
